...
public class LoginActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isLoggedIn) {
                    currentUser = users.get(userName.getText().toString());
                    Intent posts = new Intent(v.getContext(), PostsActivity.class);
                    posts.putExtra(Helper.CURRENT_USER, currentUser.getUserName());
    ...
    private boolean logIn(String userName, String password) {
        ...
        Password actualPass = authenticate.get(currentUser.getUserName());
        if (actualPass == null) {
            Toast.makeText(this, INVALID_USER,
                    Toast.LENGTH_SHORT).show();
            return false;
